...
class Home extends React.Component<any, any> {
    ...
    const providerOptions = {
      ...
      [IN_WALLET_NAME]: {
        ...
        connector: async (ProviderPackage: any, options: any) => {
          ...
          await provider.enable(this.props.dialog);
  ...
  public testOpenDialog = async () => {
    const test = await this.props.dialog.prompt("Hi a Cuwowfng");
    console.log('TEST OPEN Dialog: ', test)
  }
              ...
              <SBalances>
                ...
                <Column center>
                  <STestButtonContainer>
                    ...
                    <STestButton left onClick={this.testOpenDialog}>
                      testOpenDialog
                    </STestButton>
